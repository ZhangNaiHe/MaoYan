...
module.exports.tickets = (req, res) => {
    // console.log(req.query.id);
        connection.query('insert into ticket(projection_time,movie_names,seats,money,names) values("'+ req.query.date +'","'+ req.query.name +'","'+ req.query.id +'","'+ req.query.money+'","'+req.query.where+'")', (error, result) => {
            if (error) return console.log(error);
